...
<?php include('header.php');
	...
	?>
<div class="content" style="background:url(images/p1.jpg); background-size:1300px 900px">
	<div class="wrap">
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style=" background-color: rgba(100, 100, 100, 0.0);font-family: 'Permanent Marker', cursive;"><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
							...
							{
								?>
								<h3 style="background-color:rgba(100,100,100,0.0);font-family: 'Permanent Marker', cursive;">No Show Available</h3>
								<?php
							}
							?>
