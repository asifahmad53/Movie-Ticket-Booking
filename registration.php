...
<div class="content" style="background:url(images/p19.jpg); background-size: 1300px 700px;">
	<div class="wrap">
		<div class="content-top" style="min-height:300px;padding:50px">
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default" style="background-color:rgba(100,100,100,0.6);">
