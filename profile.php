...
if(!isset($_SESSION['user']))
{
	...
	?>
<div class="content"  style="background:url(images/pe.jpg); background-size:1300px 900px">
	<div class="wrap">
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2" style="background-color:rgba(100,100,100,0.5);">	
						<h3 style="background-color:rgba(100,100,100,0.0);">BOOKINGS</h3>
